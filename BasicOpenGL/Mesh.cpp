...
/**
 * Draws the mesh.\n
 * Expects fragment shader to contain diffuse and specular maps following convention:
 * "texture_diffuseN" or "texture_specularN".
 * \param shader: Shader object used to draw mesh
 */
